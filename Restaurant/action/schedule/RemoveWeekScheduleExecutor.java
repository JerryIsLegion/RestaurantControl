...
class RemoveWeekScheduleExecutor implements ScheduleExecutor {
    @Override
    public void execute() {
        ...
        try {
            ...
            for (int i = 2; i <= resultSetMetaData.getColumnCount(); i++) {
                PreparedStatement preparedStatement = connection.prepareStatement("update schedule set " + resultSetMetaData.getColumnName(i) + " = default where id = ?");
